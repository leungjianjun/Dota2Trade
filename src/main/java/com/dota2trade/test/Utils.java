...
class Utils {
    ...
    static Map<String, Object> httpRequest(String url, String method, String accept, String formPostData, int timeOutInMilliseconds) {
        ...
        try {
            ...
            if (code != 200)
                throw new org.expressme.openid.OpenIdException("Bad response code: " + code);
            // handle content:
            ...
            throw new org.expressme.openid.OpenIdException("Request failed: " + url, e);
        }
        finally {
            if(output!=null) {
    ...
    public static byte[] gunzip(byte[] data) {
        ...
        try {
            ...
            throw new org.expressme.openid.OpenIdException(e);
        }
        finally {
            if(input!=null) {
                try {
